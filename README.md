...
$\color{#FF0066}{\text{Akár ennek mintájára más szakmákra is érdemes lehet hasonlót elkészíttetni,}}$
$\color{#FF0066}{\text{amihez a fenti kód jó kiindulási alap csak oszd meg Geminivel, miközben a Deep Reasearch be van pipálva és írd meg neki,}}$
$\color{#FF0066}{\text{ melyik szakma érdekel ennek mintájára!.}}$
